...
import spotify_img from "../Pictures/spotify_img.png"
...
const Projects = () => {
  return (
    <div className='Project_'>
            ...
            <h1 className='project_name'>Spotify Clone</h1>
             <h3 className=' code_live'>View Code on Github</h3>
              <img className='project_img' src={spotify_img} alt="" />
